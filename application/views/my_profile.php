							...
							<div class="pd-20 card-box height-100-p">
								<div class="profile-photo">
									...
									<!-- <img
										...
										class="avatar-photo"
									/> -->
									<img id="image" class="avatar-photo" src="<?php echo $user_data['PROFILE_PICTURE']; ?>" alt="Picture" />
									<div
										class="modal fade"
										id="modal"
										tabindex="-1"
											...
											<div class="modal-content">
												<div class="modal-body pd-5">
													<div class="img-container">
														<img
															id="image"
															src="vendors/images/profile_pictures/photo2.jpg"
															alt="Picture"
														/>
													</div>
												</div>
								...
								<h5 class="text-center h5 mb-0"><?=$user_data['NAME']?></h5>
