...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <a class="btn btn-warning" href="<?= base_url('/lead-status-list'); ?>" role="button">
                        Back To List
                    </a>
                </div>
            </div>
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form action="<?= base_url('edit-lead-status/' . $lead_data['ID']) ?>" method="post">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="STATUS" placeholder="Status" required value="<?= $lead_data['STATUS'] ?>" />
                            </div>
                        </div>
                    </div>
                </div>
