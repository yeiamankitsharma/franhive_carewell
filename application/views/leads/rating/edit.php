...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form action="<?= base_url('edit-rating/' . $lead_data['ID']) ?>" method="post">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="RATING" placeholder="RATING" required value="<?= $lead_data['RATING'] ?>" />
                            </div>
                        </div>
                    </div>
                </div>
