...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form action="<?= base_url('add-rating/') ?>" method="post">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            <label class="col-form-label col-md-4">Rating <span style="color: red;">*</span></label>
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="RATING" placeholder="Rating" required />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-6 offset-md-2">
                        <button type="submit" class="btn btn-warning">Add Rating</button>
                    </div>
                </div>
            </form>
        </div>
