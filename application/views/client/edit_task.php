...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <a class="btn btn-warning" href="<?= base_url('clientController/getAllTasks'); ?>" role="button">
                        Back To Task List
                    </a>
                </div>
            </div>
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form action="<?= base_url('clientController/updateTask') ?>" method="post">
                            ...
                            <div class="col-md-8">
                                <select name="ASSIGN_TO" id="ASSIGN_TO" class="form-control" onchange="" <?= $user_role != 'ADMIN' ? 'disabled' : '' ?>>
                                    ...
                                    foreach ($all_users as $user) { ?>
                                        <option value="<?= $user['USER_ID'] ?>" <?= $task_data['ASSIGN_TO'] == $user['USER_ID'] ? 'selected' : '' ?>><?= $user['NAME'] ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>
