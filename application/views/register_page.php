		...
		<div class="container-fluid d-flex justify-content-between align-items-center">
			<div class="brand-logo">
				<a href="<?php echo base_url() ?>login">
					<img src="<?= base_url('vendors/images/franhive_logo-removebg.png'); ?>" alt="" />
				</a>
			</div>
				...
				<div class="col-md-6 col-lg-5">
					<div class="register-box bg-white box-shadow border-radius-10">
						<div class="wizard-content">
							<form class="tab-wizard wizard-circle wizard" method="POST" action="<?php echo base_url('register'); ?>">
								...
								<section>
									<div class="form-wrap max-width-600 mx-auto">
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<select class="form-control selectpicker" title="Select Country">
