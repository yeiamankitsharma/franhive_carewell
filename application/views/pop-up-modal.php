    ...
    <div class="row">
        <div class="col-md-6">
            <div class="error-template">
                ...
                <div class="error-actions" onclick="<?php echo base_url('admin/index'); ?>">
                    <a href="<?php echo base_url('admin/index'); ?>" style="margin-top: 10px;" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-home">
                        </span>Take Me Home </a>
                </div>
            </div>
        </div>
